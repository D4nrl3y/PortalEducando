...
//        });
    ...
    public void acessoDireto (View v) {
        ...
        webView.loadUrl("http://172.16.1.35:8080/PortalEducando/ViewAluno/graficoMobile.jsp");
...
//        http://172.16.1.35:8080/WebServicePortalEducando/WebContent/graficoMobile.jsp
    ...
    public void acessoDireto2 (View v) {
        ...
        webView.getSettings().setJavaScriptEnabled(true);
        webView.setScrollBarStyle(View.SCROLLBARS_INSIDE_OVERLAY);
        webView.loadUrl("http://172.16.1.35:8080/PortalEducando/ViewAluno/graficoMobile2.jsp");
    }
